        ...
        <div>
            ...
            <div class="input-group mb-3">
                <div style="width: 33.3333333%;" class="pe-1">
                    ...
                    <input name="barrio" required id="perfilBarrio" class="form-control" type="text" value="{{$direccion->barrio}}">
                </div>
                <div style="width: 33.3333333%;" class="pe-1 ps-1">
                    <label class="form-label me-2" for="perfilDireccion">Direccion</label>
                    <input name="direccion" required id="perfilDireccion" class="form-control" type="text" value="{{$direccion->direccion}}">
                </div>
                <div style="width: 33.3333333%;" class="ps-1">
                    <label class="form-label me-2" for="perfilPiso">Piso</label>
                    <input name="piso" id="perfilPiso" class="form-control" type="text" value="{{$direccion->piso}}">
                </div>
            </div>
            <a href="{{route('direcciones')}}" class="btn btn-secondary mb-3 mt-4">Volver</a>
            <input type="submit" class="btn btn-primary float-end mb-3 mt-4" value="Guardar edicion">
        </div>
        <script>
